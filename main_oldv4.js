console.log("🚀 LockedIn: Gaze Keyboard + Live Cursor + Calibration");
...
// === Gaze Mapping + Live Cursor ===
function handleGazeSelection(gx, gy) {
  // Map model coords → page coords
